...
- Current observed Open-Meteo state on April 24, 2026:
  ...
  extends through `2024-05-30` and `2026-01-21`. A slow day-by-day crawl with
  `--rate-limit-profile free`, `--http-timeout-seconds 15`, `--http-retries 1`,
  and 20-second inter-day cooldown still returned only `retryable_error` for
  `2026-01-22..2026-01-28`, while `2024-05-25..2024-05-30` still added `130`
  rows the same day. Current recent-date collection is therefore limited by
  upstream throttling rather than a simple full-day hard stop.
