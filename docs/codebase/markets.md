...
- `clob_read_client.py` and `ws_market.py`: public price, book, and stream reads
...
- Output: validated `MarketSpec`, normalized outcome schemas, public price snapshots, supported-city watchlists, and curated `MarketSnapshot[]` inventories
