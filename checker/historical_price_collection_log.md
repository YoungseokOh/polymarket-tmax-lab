...
| 2026-04-27 | `targeted Beijing/Chengdu/Chongqing/Madrid / 68` | targeted price-history backfill + variant panels | success | 68 | n/a | `backfill-price-history --only-missing --price-no-cache` wrote `748` ok requests and `36030` points. Target panel `targeted_east_madrid_backtest_panel_20260427` has `2211` rows with `ok=1868`, `missing=302`, `stale=41`; full local backlog panel `historical_backtest_panel_curated_multisource_targeted_east_madrid_20260427` has `54261` rows with `ok=17820`, `missing=36349`, `stale=92`. Checked-in inventory shard queue remains `500..524 / 1834`. |
| 2026-04-27 | `discovery120 Tokyo / 1` | targeted price-history backfill + variant panels | success | 1 | n/a | `backfill-price-history --only-missing --price-no-cache` wrote `11` ok requests and `565` points. Target panel `targeted_discovery120_backtest_panel_20260427` has `33` rows with `ok=22`, `missing=11`, `stale=0`; full local backlog panel `historical_backtest_panel_curated_multisource_discovery120_20260427` has `68550` rows with `ok=30615`, `missing=37501`, `stale=434`. Checked-in inventory shard queue remains `500..524 / 1834`. |
